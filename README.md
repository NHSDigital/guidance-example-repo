# guidance-example-repo

![Build](https://github.com/NHSDigital/guidance-example-repo/workflows/Build/badge.svg?branch=master)

This is a specification for the *guidance-example-repo* API.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/guidance-example-repo/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/guidance-example-repo/blob/master/CODE_OF_CONDUCT.md).
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `guidance-example-repo-target`.
